...
//        Memanggil Data Kelas
    ...
    private void initComponents() {
        ...
        ckereta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Jayakarta", "Senja Utama", "Argo Wilis" }));
        ...
        stasiun_awal.setText("Purwokerto (PWT)");
    ...
    private void ckeretaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ckeretaActionPerformed
        ...
        if(ckereta.getSelectedItem().equals("Jayakarta")){
        bayangan4.setValue(0);
        ckereta.setSelectedIndex(0);
       }else if(ckereta.getSelectedItem().equals("Senja Utama")){
       bayangan4.setValue(1);
       ckereta.setSelectedIndex(1);
       }
       else if(ckereta.getSelectedItem().equals("Argo Wilis")){
       bayangan4.setValue(2);
       ckereta.setSelectedIndex(2);
       }
       
       if(ckereta.getSelectedItem().equals("Jayakarta") && stasiun_tujuan.getSelectedItem().equals("Surabaya Gubeng (SGU)")){
            berangkat.setText("08.30 WIB");
            tiba.setText("20.19 WIB");
        }else if(ckereta.getSelectedItem().equals("Jayakarta") && stasiun_tujuan.getSelectedItem().equals("Gambir (GMR)")){
            berangkat.setText("06.30 WIB");
            tiba.setText("09.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Jayakarta") && stasiun_tujuan.getSelectedItem().equals("Solo Balapan (SLO)")){
            berangkat.setText("07.20 WIB");
            tiba.setText("16.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Jayakarta") && stasiun_tujuan.getSelectedItem().equals("Semarang Tawang (SMT)")){
            berangkat.setText("06.15 WIB");
            tiba.setText("13.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Jayakarta") && stasiun_tujuan.getSelectedItem().equals("Banjar (BJR)")){
            berangkat.setText("09.10 WIB");
            tiba.setText("13.03 WIB");
            
            //Senja Utama 
        }else if(ckereta.getSelectedItem().equals("Senja Utama") && stasiun_tujuan.getSelectedItem().equals("Surabaya Gubeng (SGU)")){
            berangkat.setText("07.30 WIB");
            tiba.setText("19.19 WIB");
        }else if(ckereta.getSelectedItem().equals("Senja Utama") && stasiun_tujuan.getSelectedItem().equals("Gambir (GMR)")){
            berangkat.setText("08.30 WIB");
            tiba.setText("11.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Senja Utama") && stasiun_tujuan.getSelectedItem().equals("Solo Balapan (SLO)")){
            berangkat.setText("09.20 WIB");
            tiba.setText("18.15 WIB");
        }else if(ckereta.getSelectedItem().equals("Senja Utama") && stasiun_tujuan.getSelectedItem().equals("Semarang Tawang (SMT)")){
            berangkat.setText("08.15 WIB");
            tiba.setText("15.45 WIB");
        }else if(ckereta.getSelectedItem().equals("Senja Utama") && stasiun_tujuan.getSelectedItem().equals("Banjar (BJR)")){
            berangkat.setText("10.10 WIB");
            tiba.setText("14.03 WIB");
            
            //Argo Wilis
        }else if(ckereta.getSelectedItem().equals("Argo Wilis") && stasiun_tujuan.getSelectedItem().equals("Surabaya Gubeng (SGU)")){
            berangkat.setText("08.15 WIB");
